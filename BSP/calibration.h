...
#define CALIBRATION_STEPS 			((uint32_t)32768)	//传感器范围为(0-32767)

#define ANGLE_WRAP 							((int32_t)32768)
#define ANGLE_STEPS 						((uint32_t)65536) //标定后角度范围为(0-65535代表0-360度)
#define ANGLE_MAX 							((uint16_t)65535) //角度最大值为65535
