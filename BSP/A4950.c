...
{
#if NO_OLED_MODE
	if (state == 0)	//IN1 = 1, IN2 =0
	{
		GPIO_SetBits(PIN_A4950, PIN_A4950_IN1);		GPIO_SetBits(GPIOA, GPIO_Pin_5);
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN2);	GPIO_ResetBits(GPIOA, GPIO_Pin_7);
	}
	if (state == 1)//IN1=0	 //IN2=1	
	{
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN1);	GPIO_ResetBits(GPIOA, GPIO_Pin_5);
		GPIO_SetBits(PIN_A4950, PIN_A4950_IN2);		GPIO_SetBits(GPIOA, GPIO_Pin_7);
	}
	if (state == 3)//IN1=0  //IN2=0
	{
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN1);	GPIO_ResetBits(GPIOA, GPIO_Pin_5);
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN2);	GPIO_ResetBits(GPIOA, GPIO_Pin_7);
	}
...
inline static void bridge2(int state)
{
	...
	if (state == 0)	//IN1 = 1, IN2 =0
	{
		GPIO_SetBits(PIN_A4950, PIN_A4950_IN3);		GPIO_SetBits(GPIOA, GPIO_Pin_6);
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN4);	GPIO_ResetBits(GPIOA, GPIO_Pin_4);
	}
	if (state == 1)//IN1=0	 //IN2=1	
	{
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN3);	GPIO_ResetBits(GPIOA, GPIO_Pin_6);
		GPIO_SetBits(PIN_A4950, PIN_A4950_IN4);		GPIO_SetBits(GPIOA, GPIO_Pin_4);
	}
	if (state == 3)//IN1=0  //IN2=0
	{
		GPIO_ResetBits(PIN_A4950, PIN_A4950_IN3);	GPIO_ResetBits(GPIOA, GPIO_Pin_6);
